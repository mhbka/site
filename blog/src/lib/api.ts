...
export type { Comment, CreateCommentInput } from './models/comments.ts';
export type { CreatePostInput, Post, PostStatus, PostSummary, UpdatePostInput } from './models/posts.ts';
